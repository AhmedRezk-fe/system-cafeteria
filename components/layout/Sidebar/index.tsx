...
const Sidebar = ({stateNavASidebar }:{stateNavASidebar: (ss:string)=> void}) => {
  ...
  const wrapperClasses = classNames(
    "py-8 pb-4 bg-25 text-50 start-0 top-0 fixed h-screen overflow-outo",
    {
  ...
  const collapseIconClasses = classNames("absolute right-0 top-0 rotate-180", {
    ...
    <div className={wrapperClasses}>
      <div className="flex flex-col">
        ...
        <div className="bg-50 text-25 flex items-center flex-row py-4 px-4">
          ...
          {!toggleCollapse && <span className="w-full px-4 flex-row">ddd</span>}
        </div>
