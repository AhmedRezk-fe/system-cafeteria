    ...
    <Layout>
      ...
      <div className="flex justify-between items-center gap-5">
          <div className="w-full">
            <Input
              type="text"
              placeholder="ابحث باسم القسم او الكود ......"
              name="search"
              placeIcon="start"
            >
              <svg
        ...
        <div className="my-4 py-6 text-center font-bold text-2xl rounded-[10px] bg-200 text-100">اجمالى عدد كل اقسام الاصناف: 250</div>
      <BodyTable />
    </Layout>
  );
};
