      ...
      <div className="">
        ...
        <div className="flex justify-between my-6">
          <div className="w-auto min-w-[30%]">
            <Select placeholder="اختر مجموعة الاصناف" label='مجموعة الاصناف' name="categories" />
          </div>

          <div className="w-auto min-w-[30%]">
            <Select placeholder="اختر القسم" label='قسم اصناف المخزن' name="categories" />
          </div>

          <div className="w-auto min-w-[30%]">
            <Select placeholder="اختر صنف المخزن" label='صنف المخزن' name="categories" />
          </div>
        </div>

        <div className="flex justify-between my-6">
          <div className="mb-[15px] w-auto min-w-[30%]">
            <Input
              type="text"
              eventInput={handleClick}
              placeholder="ادخل الكمية المضافة"
              name="n"
              label="الكمية"
              placeIcon="start"
            />
        ...
        <div className="mb-[15px] my-6">
            <Input
              type="text"
              eventInput={handleClick}
              placeholder="ادخل رقم الباركود الخاص بالصنف"
              name="n"
              label="رقم الباركود الخاص بالصنف"
              placeIcon="start"
            />
          </div>

        <div className="flex items-center flex-col justify-center w-full">
          <p className="text-start mb-4 w-full">اضافة لوجو للصنف</p>
        ...
        <div className="flex gap-4 mt-8">
          ...
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M6 12H18" stroke="#1664B8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M12 18V6" stroke="#1664B8" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </Button>
        </div>
